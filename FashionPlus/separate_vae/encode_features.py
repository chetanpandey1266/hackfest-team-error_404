...
label_dict = dict()
print(os.getcwd)
with open("../classification/data_dict/shape_and_feature/datasets/humanparsing/garment_label_part_map.json", 'r') as readfile:
    print(opt.dataset_param_file)
...
if demo:
    save_name = os.path.join('../generation/results/Lab/demo', '%s_shape_codes.p' % opt.phase)
else:
